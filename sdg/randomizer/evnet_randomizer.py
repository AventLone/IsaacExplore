...
class EventRandomizer:
    ...
    def __init__(self, prim_path: str, camra_height: float, 
                 camera_radiuses: list[float], material_count=300) -> None:
        ...
        self._camera_poses = EventRandomizer.get_orbit_points(height=camra_height, radiuses=camera_radiuses)
    ...
    def _randomize_light(self) -> rep.scripts.utils.ReplicatorItem:
        ...
        with lights:
            rep.modify.attribute("intensity", rep.distribution.choice([1000, 5000, 20000, 40000, 80000, 120000]))
